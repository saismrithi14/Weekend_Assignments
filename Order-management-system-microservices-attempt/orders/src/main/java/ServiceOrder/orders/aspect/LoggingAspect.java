package ServiceOrder.orders.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* ServiceOrder.orders.service.*.*(..))")
    ...
    @Around("execution(* ServiceOrder.orders.service.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* ServiceOrder.orders.service.*.*(..))", throwing = "ex")
    ...
    @AfterReturning(pointcut="execution(* ServiceOrder.orders.service.*.*(..))", returning = "result")
    ...
    @Before("execution(* ServiceOrder.orders.controller.*.*(..))")
    ...
    @Around("execution(* ServiceOrder.orders.controller.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* ServiceOrder.orders.controller.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* ServiceOrder.orders.controller.*.*(..))", throwing = "ex")
