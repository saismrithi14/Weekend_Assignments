package ServiceProduct.products.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* ServiceProduct.products.service.*.*(..))")
    ...
    @Around("execution(* ServiceProduct.products.service.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* ServiceProduct.products.service.*.*(..))", throwing = "ex")
    ...
    @AfterReturning(pointcut="execution(* ServiceProduct.products.service.*.*(..))", returning = "result")
    ...
    @Before("execution(* ServiceProduct.products.controller.*.*(..))")
    ...
    @Around("execution(* ServiceProduct.products.controller.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* ServiceProduct.products.controller.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* ServiceProduct.products.controller.*.*(..))", throwing = "ex")
